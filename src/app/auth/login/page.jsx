...
export default function LoginPage() {
  ...
  >
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" color="cyan" className="mt-8 w-full bg-black text-white py-2 rounded-md shadow-sm hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 font-medium">
        Sign in to account
      </button>
    </form>
    <div className="mt-10">
